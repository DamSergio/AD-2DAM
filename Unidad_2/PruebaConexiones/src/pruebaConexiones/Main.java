...
//
	...
	public static void oracle() throws ClassNotFoundException, SQLException {
		...
		Connection conexion1 = DriverManager.getConnection("jdbc:oracle:thin:localhost:1521:XE", "sys","1234");
	...
	public static void hsqldb() throws ClassNotFoundException, SQLException {
		...
		Connection conexion1 = DriverManager.getConnection("jdbc:hsqldb:file:../misDB/hsqldb/ejemplo/ejemplo");
		String sql = "SELECT * FROM departamentos";
		Statement sentencia = conexion1.createStatement();
		boolean valor = sentencia.execute(sql);
	...
	public static void derby() throws ClassNotFoundException, SQLException {
		...
		Connection conexion1 = DriverManager.getConnection("jdbc:derby:./misDB/derby/ejemplo");
	...
	public static void h2() throws ClassNotFoundException, SQLException {
		...
		Connection conexion1 = DriverManager.getConnection("jdbc:h2:../misDB/h2/ejemplo", "sa", "");
	...
	public static void sqlite() throws ClassNotFoundException, SQLException {
		...
		Connection conexion1 = DriverManager.getConnection("jdbc:sqlite:../misDB/sqlite/ejemplo.db");
